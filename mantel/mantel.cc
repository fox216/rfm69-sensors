  ...
  if (radio.receiveDone() ) {
    ...
    switch(nodeMsg.TypeID) {
      ...
      case speedCtrl:
        ...
        // Zero of Off will stop glitter from advancing
        sysState.updatesPerSecond = (Sensor_speedCtrl.speedNum/10);
        // Serial.println(sysState.updatesPerSecond);
      break;
      case glitterCtrl:
        Sensor_glitterCtrl = *(_Sensor_glitterCtrl*)nodeMsg.MsgPayload;
        
        sysState.chanceOfGlitter = 255*(Sensor_glitterCtrl.chanceOfGlitter/100);
